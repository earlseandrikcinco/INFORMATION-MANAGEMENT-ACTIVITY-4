...
INSERT INTO `classschedule` VALUES ('CS101-A','CS101','08:00:00','09:30:00','MWF',1,1,3),('CS201-A','CS201','10:00:00','11:30:00','TTH',2,2,4),('ENG101-A','ENG101','15:00:00','16:30:00','TTH',4,3,4),('MATH101-A','MATH101','13:00:00','14:30:00','MWF',3,1,3),('MATH222','565','07:00:00','08:00:00','MTWThFS',3,2,NULL);
...
--
-- Dumping routines for database 'pls'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_CheckScheduleConflict`(p_excludeClassCode VARCHAR(20),
    p_roomID INT,
    p_instructID INT,
    p_days VARCHAR(10),
    p_startTime TIME,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_CheckAttendance` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CheckAttendance`(
    IN p_classCode       VARCHAR(20),
    IN p_date            DATE,
    IN p_status          VARCHAR(20),
    IN p_checkerID       INT,
    IN p_actualInstructID INT,
    IN p_leaveRequestID   INT,
    IN p_remarks         TEXT
)
BEGIN
    INSERT INTO attendance
        (classCode, startDate, endDate, instructorStatus, checkedBy,
         actualInstructID, leaveRequestID, remarks)
    VALUES
        (p_classCode, p_date, p_date, p_status, p_checkerID,
         p_actualInstructID, p_leaveRequestID, p_remarks)
    ON DUPLICATE KEY UPDATE
        instructorStatus  = VALUES(instructorStatus),
        checkedBy         = VALUES(checkedBy),
        actualInstructID  = VALUES(actualInstructID),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetClassSchedulesByInstructor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetClassSchedulesByInstructor`(IN p_instructID INT)
BEGIN
    SELECT s.*, i.name AS instructorName
    FROM classschedule s
    LEFT JOIN instructor i ON s.instructID = i.instructID
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetClassSchedulesByRoom` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetClassSchedulesByRoom`(IN p_roomID INT)
BEGIN
    SELECT s.*, i.name AS instructorName
    FROM classschedule s
    LEFT JOIN instructor i ON s.instructID = i.instructID
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetClassSchedulesByTimeRange` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetClassSchedulesByTimeRange`(
    IN p_dayCode VARCHAR(10),
    IN p_start   TIME,
    IN p_end     TIME
)
BEGIN
    ...
    FROM classschedule s
    LEFT JOIN instructor i ON s.instructID = i.instructID
    WHERE fn_DaysOverlap(s.days, p_dayCode)
      AND s.startTime < p_end
      AND s.endTime   > p_start
    ORDER BY s.startTime;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetSystemUser` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetSystemUser`(IN p_username VARCHAR(50))
BEGIN
    SELECT * FROM systemuser WHERE username = p_username;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    WHILE v_curr <= v_end DO
        ...
        INSERT INTO attendance
            (classCode, startDate, endDate, instructorStatus, leaveRequestID)
        SELECT cs.classCode, v_curr, v_curr, 'Absent', p_leaveRequestID
        FROM classschedule cs
        WHERE cs.instructID = v_instructID
          AND fn_DaysOverlap(cs.days, @dayLetter)
        ON DUPLICATE KEY UPDATE
...
BEGIN
    -- Requires UNIQUE KEY on (classCode, startDate) for ON DUPLICATE KEY to work.
    -- See ALTER TABLE at the bottom of this file.
    INSERT INTO attendance
        (classCode, startDate, endDate, instructorStatus, checkedBy,
         actualInstructID, leaveRequestID, remarks)
    VALUES
...
-- Dump completed on 2026-05-14 20:07:31
